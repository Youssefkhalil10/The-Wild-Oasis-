...
function SalesChart({ bookings = [], numDays }) {
  ...
  //return an array have all dates between Start and End.
  const allDates = eachDayOfInterval({
    //subDays =>numDays ترجع تاريخ قبل عدد ايام معين ، في الحاله دي بيكون قيمه
  ...
  const data = allDates.map((date) => {
    return {
      ...
      totalSales: bookings
        //isSameDay => compare between two Dates and return true or false.
